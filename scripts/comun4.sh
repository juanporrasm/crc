...
sudo dnf install -y container-tools containers-common-extra containers-common conmon podman-compose podman-plugins golang netavark kubernetes-kubectl helm httpd-tools
